...
import { Folder, ChevronDown, User, X, UserPlus } from "lucide-react";
...
import { createTeamAndAddUser, createProject, fetchTeamsForUser, fetchProjectsForTeam, getCurrentUserId, fetchAllUserTeamForTeam, fetchUser, checkNewTeamMember, deleteProject, deleteTeam, createUserTeam, fetchUserByUserName } from '../supabase/backendFunctions';
